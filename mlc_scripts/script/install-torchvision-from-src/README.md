# README for install-torchvision-from-src
...
```bash
mlcr install,get,src,from.src,pytorchvision,torchvision,src-pytorchvision
```
...
- `repo.https://github.com/pytorch/vision` (default)

### Ungrouped

- `branch.#` _(# can be substituted dynamically)_
- `cuda`
- `for-nvidia-mlperf-inference-v3.1` (base: sha.657027f3, cuda)
- `for-nvidia-mlperf-inference-v4.0` (base: sha.657027f3, cuda)
- `python.#` _(# can be substituted dynamically)_
