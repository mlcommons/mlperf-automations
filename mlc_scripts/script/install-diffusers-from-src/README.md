# README for install-diffusers-from-src
...
```bash
mlcr install,get,src,from.src,diffusers,src-diffusers
```
...
- `repo.https://github.com/huggingface/diffusers` (default)

### Ungrouped

- `branch.#` _(# can be substituted dynamically)_
- `for-intel-mlperf-inference-v4.0-sdxl` (base: tag.v0.25.1)
