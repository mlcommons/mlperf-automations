# README for get-ml-model-abtf-ssd-pytorch
...
```bash
mlcr get,ml-model,abtf-ssd-pytorch,ssd,resnet50,cmc
```
...
- `e01`
- `e65`
- `local.#` _(# can be substituted dynamically)_
- `skip_weights` (default)
