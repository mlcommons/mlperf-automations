# README for install-pytorch-from-src
...
```bash
mlcr install,get,src,from-src,from.src,pytorch,src-pytorch
```
...
- `repo.https://github.com/pytorch/pytorch` (default)
...
- `cuda`
- `for-intel-mlperf-inference-resnet50` (base: tag.v1.12.0-rc7, pr-to-apply.pull/76869/head)
- `for-intel-mlperf-inference-retinanet` (base: tag.v1.12.0-rc7, pr-to-apply.pull/89925/head, cherrypicks.78cad998e505b667d25ac42f8aaa24409f5031e1)
- `for-intel-mlperf-inference-v3.1-bert` (base: tag.v1.12.0)
- `for-intel-mlperf-inference-v3.1-dlrm-v2` (base: sha.927dc662386af052018212c7d01309a506fc94cd)
- `for-nvidia-mlperf-inference-v3.1` (base: sha.b5021ba9, cuda)
- `for-nvidia-mlperf-inference-v4.0` (base: sha.32f93b1, cuda)
