...
|------|-------------|---------|------|
| `--namd_tarball_path` | Path to a manually downloaded NAMD source tarball (NAMD requires registration at https://www.ks.uiuc.edu/Development/Download/download.cgi?PackageName=NAMD) |  | `` |
