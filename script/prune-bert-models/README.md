...
```bash
mlcr prune,bert-models,bert-prune,prune-bert-models
```
...
- `model.#` _(# can be substituted dynamically)_
- `path.#` _(# can be substituted dynamically)_
- `task.#` _(# can be substituted dynamically)_
