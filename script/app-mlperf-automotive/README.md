# README for app-mlperf-automotive
...
```bash
mlcr app,app-mlperf-inference,app-mlperf-inference-automotive,mlperf-inference,mlperf-inference-automotive,abtf-inference
```
...
- `mlcommons-python` (alias: reference) (default)
