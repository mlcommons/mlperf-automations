# README for get-mlperf-inference-src
...
```bash
mlcr get,src,source,inference,inference-src,inference-source,mlperf,mlcommons
```
...
- `deepsparse` (base: _branch.deepsparse, _repo.https://github.com/gateoverflow/nm-inference)
- `gn`
- `no-recurse-submodules`
- `nvidia-pycocotools` (base: patch)
- `octoml` (base: short-history, _repo.https://github.com/octoml/inference)
- `openimages-nvidia-pycocotools` (base: patch)
- `patch`
- `pybind`
- `recurse-submodules`
