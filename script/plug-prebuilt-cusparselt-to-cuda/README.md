# README for plug-prebuilt-cusparselt-to-cuda
...
```bash
mlcr plug,prebuilt-cusparselt,to-cuda
```
...
|------|-------------|---------|------|
| `--tar_file` | Full path to the cuSPARSELt Tar file downloaded from Nvidia website (https://developer.nvidia.com/cusparselt-downloads) |  | `` |
| `--skip_sudo` |  |  | `` |
