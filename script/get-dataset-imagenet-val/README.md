# README for get-dataset-imagenet-val
...
```bash
mlcr get,val,validation,dataset,imagenet,ILSVRC,image-classification,original
```
...
- `2012-500` (base: size.500, 2012)
- `2012-full` (base: full, 2012)
