# README for push-mlperf-inference-results-to-github
...
```bash
mlcr push,mlperf,mlperf-inference-results,publish-results,inference,submission,github
```
...
| `--branch` |  |  | `` |
| `--commit_message` |  |  | `` |
| `--repo_branch` | Alias for branch |  | `` |
| `--repo_url` |  |  | `https://github.com/mlcommons/mlperf_inference_submissions_v4.0` |
| `--submission_dir` |  |  | `` |
