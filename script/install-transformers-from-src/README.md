# README for install-transformers-from-src
...
```bash
mlcr install,src,from.src,transformers,src-transformers
```
...
- `for-intel-mlperf-inference-v3.1-bert` (base: sha.9f4e0c23d68366985f9f584388874477ad6472d8)
