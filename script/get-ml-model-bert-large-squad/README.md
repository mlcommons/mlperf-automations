# README for get-ml-model-bert-large-squad
...
```bash
mlcr get,ml-model,raw,bert,bert-large,bert-squad,language,language-processing
```
...
- `amazon-s3`
- `armi`
- `custom-url.#` _(# can be substituted dynamically)_
- `github`
- `zenodo`
