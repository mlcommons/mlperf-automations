# README for run-mlperf-inference-mobilenet-models
...
```bash
mlcr run,mobilenet,models,image-classification,mobilenet-models,mlperf,inference
```
...
- `tflite-default` (default)

### Run-mode

- `accuracy-only`
- `find-performance`
- `performance-and-accuracy` (default)
- `performance-only`
- `submission`
