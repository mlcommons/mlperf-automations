# README for get-dataset-imagenet-aux
...
```bash
mlcr get,aux,dataset-aux,image-classification,imagenet-aux
```
...
- `from.berkeleyvision` (base: 2012)
- `from.dropbox` (base: 2012)
- `from.go` (base: 2012) (default)
