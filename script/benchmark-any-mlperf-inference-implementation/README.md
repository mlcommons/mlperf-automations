# README for benchmark-any-mlperf-inference-implementation
...
```bash
mlcr benchmark,run,natively,all,inference,any,mlperf,mlperf-implementation,implementation,mlperf-models
```
