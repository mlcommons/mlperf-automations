...
|------|-------------|---------|------|
| `--nwchem_modules` | NWChem modules to compile (default is 'all') |  | `all` |
| `--armci_network` | ARMCI network to use (default is 'MPI-PR') |  | `MPI-PR` |
