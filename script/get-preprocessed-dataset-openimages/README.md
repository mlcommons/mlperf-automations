# README for get-preprocessed-dataset-openimages
...
```bash
mlcr get,dataset,openimages,open-images,object-detection,preprocessed
```
...
- `for.retinanet.onnx`
- `nvidia`
- `quant-offset.#` _(# can be substituted dynamically)_
- `quant-scale.#` _(# can be substituted dynamically)_
