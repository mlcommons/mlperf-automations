# README for install-tpp-pytorch-extension
...
```bash
mlcr install,get,src,from.src,tpp-pex,src-tpp-pex
```
...
- `repo.https://github.com/libxsmm/tpp-pytorch-extension` (default)

### Ungrouped

- `branch.#` _(# can be substituted dynamically)_
- `for-intel-mlperf-inference-v3.1-gptj` (base: branch.mlperf_infer_31)
