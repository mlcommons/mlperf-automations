# README for install-intel-neural-speed-from-src
...
```bash
mlcr install,src,from.src,neural-speed,intel-neural-speed
```
...
- `repo.https://github.com/intel/neural-speed` (default)
