# README for calibrate-model-for.qaic
...
```bash
mlcr qaic,calibrate,profile,qaic-profile,qaic-calibrate
```
...
- `seq.#` _(# can be substituted dynamically)_
- `seq.384`

### Ungrouped

- `bert_`
- `first.#` _(# can be substituted dynamically)_
