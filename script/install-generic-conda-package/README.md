# README for install-generic-conda-package
...
```bash
mlcr get,install,generic,generic-conda-lib,conda-lib,conda-package,generic-conda-package
```
...
- `source.#` _(# can be substituted dynamically)_
- `source.intel`

### Ungrouped

- `name.#` _(# can be substituted dynamically)_
