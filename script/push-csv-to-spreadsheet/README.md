# README for push-csv-to-spreadsheet
...
```bash
mlcr push,google-spreadsheet,spreadsheet,push-to-google-spreadsheet
```
...
| `--csv_file` |  |  | `` |
| `--sheet_name` |  |  | `` |
| `--spreadsheet_id` |  |  | `1gMHjXmFmwZR4-waPPyxy5Pc3VARqX3kKUWxkP97Xa6Y` |
