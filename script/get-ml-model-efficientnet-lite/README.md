# README for get-ml-model-efficientnet-lite
...
```bash
mlcr get,ml-model,efficientnet,raw,ml-model-efficientnet,ml-model-efficientnet-lite,lite,tflite,image-classification
```
...
- `lite0` (base: resolution-224) (default)
- `lite1` (base: resolution-240)
- `lite2` (base: resolution-260)
- `lite3` (base: resolution-280)
- `lite4` (base: resolution-300)
