# README for get-preprocessed-dataset-squad
...
```bash
mlcr get,dataset,preprocessed,tokenized,squad
```
...
- `doc-stride.#` _(# can be substituted dynamically)_
- `doc-stride.128` (default)
...
- `seq-length.#` _(# can be substituted dynamically)_
- `seq-length.384` (default)
