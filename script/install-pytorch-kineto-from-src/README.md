# README for install-pytorch-kineto-from-src
...
```bash
mlcr install,get,src,from.src,pytorch-kineto,kineto,src-pytorch-kineto
```
...
- `repo.https://github.com/pytorch/kineto` (default)
