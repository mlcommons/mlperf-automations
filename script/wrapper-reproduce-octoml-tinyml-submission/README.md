# README for wrapper-reproduce-octoml-tinyml-submission
...
```bash
mlcr run,generate-tiny,generate,submission,tiny,generate-tiny-submission,results,mlcommons,mlperf,octoml
```
