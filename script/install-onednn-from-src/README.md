# README for install-onednn-from-src
...
```bash
mlcr install,get,src,from.src,onednn,src-onednn
```
...
- `repo.https://github.com/oneapi-src/oneDNN` (default)

### Ungrouped

- `branch.#` _(# can be substituted dynamically)_
- `for-intel-mlperf-inference-v3.1-bert` (base: tag.v2.6)
